...
public class JwtService {
    ...
    @Autowired
    private com.livares.intern.repository.TokenRepository tokenRepository;
    ...
    public String generateToken(com.livares.intern.model.User user) {
        String token = Jwts.builder().subject(user.getUsername())
                .issuedAt(new Date(System.currentTimeMillis()))
                .expiration(new Date(System.currentTimeMillis() + jwtExpiration))
                .signWith(getSigninKey()).compact();

        com.livares.intern.model.Token tokenObj = new com.livares.intern.model.Token();
